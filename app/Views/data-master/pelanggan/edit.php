...
<section class="section">
    <div class="col-lg-6">
        <div class="card"> 
            <div class="card-body">
                <h5 class="card-title" style="text-align: center;">Edit Data Pelanggan</h5>
                <form id="editPelangganForm" action="<?= base_url('data-master/pelanggan/update/' . $pelanggan['id_pelanggan']) ?>" method="post">
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">No KTP</label>
                        <div class="col-sm-10">
                            <input type="text" name="no_ktp" class="form-control" value="<?= old('no_ktp', $pelanggan['no_ktp']); ?>">
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?= base_url('data-master/pelanggan') ?>" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    document.getElementById('editPelangganForm').addEventListener('submit', function(event) {
